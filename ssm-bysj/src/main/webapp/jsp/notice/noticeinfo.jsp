        ...
        <c:forEach var="notice" items="${noticeList }" varStatus="status">
            <tr>
                ...
                <td>
                    ...
                    <span><img src="${pageContext.request.contextPath }/static/images/xiugai.png" alt="修改" title="修改"/></span>
                    <span><img src="${pageContext.request.contextPath }/static/images/schu.png" alt="删除" title="删除"/></span>
                </td>
            </tr>
        </c:forEach>
    </table>
